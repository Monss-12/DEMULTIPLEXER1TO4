...
# APPARATUS REQUIRED
pc with vivado 2023.1 software
# PROCEDURE
...
STEP:12 Load the Bit file into the SPARTAN 6 FPGA STEP:11 On the board, by giving required input, the LEDs starts to glow light, indicating the output.
# PROGRAM
```
module demux(y0,y1,y2,y3,s1,s0,I); 
input I,s0,s1; output y0,y1,y2,y3;
assign s1n = ~ s1;
assign s0n = ~ s0;
assign y0 = I & s0n & s1n;
assign y1 = I & s0 & s1n;
...
# OUTPUT
![image](https://github.com/Monss-12/DEMULTIPLEXER1TO4/assets/163823193/56fb8eb3-f883-4d16-ac5a-73469bf04968)
# RESULT
